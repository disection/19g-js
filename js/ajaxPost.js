...
const createPost =  ( objPost ) => {
    ...
    xhttp.open( 
      "POST",  
      "https://lorekoderjs19-default-rtdb.firebaseio.com/posts/.json", true)
  ...
  const updatePost  = ( idPost, postUpdated) => {
    ...
    updatexhr.open(
      'PATCH', 
      `https://lorekoderjs19-default-rtdb.firebaseio.com/posts/${idPost}.json`, 
      true
    )
  ...
  const getPosts  = (callback) => {
    ...
    getxhr.open(
      'GET', 
      `https://lorekoderjs19-default-rtdb.firebaseio.com/posts/.json`, 
      true
    )
